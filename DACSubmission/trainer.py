...
parser.add_argument('--resume', default='./save_temp/Test7_IRWeightsIdentInputHTanMTJ.th', type=str, metavar='PATH',  # ./save_temp/StoX400BestEpoch_4w4a_AdaptTS1_NoSplit.th
...
parser.add_argument('--save-every', dest='save_every',
                    ...
                    type=int, default=10)
parser.add_argument('--max-time-steps', default=4, type=int, metavar='N',
                    help='Maximum time steps for each MTJ (default: 1)')
parser.add_argument('--max-ab', default=2, type=int, metavar='N',
                    help='Denotes maximum number of activation bits (default: 1)')
parser.add_argument('--max-wb', default=2, type=int, metavar='N',
                    help='Denotes maximum number of weight bits (default: 1)')

best_prec1 = 0
Log_Vals = open("./Logs/PaperModelFin24_2w2a_4ts_128arr_128b_400ep_10lr_v3.txt", 'w')
save_name = 'PaperModelFin24_2w2a_4ts_128arr_128b_400ep_10lr_v3.th'
# Log_Vals = open("./Logs/Test7_IRWeightsIdentInputHTanMTJ.txt", 'w')
# save_name = 'Test7_IRWeightsIdentInputHTanMTJ.th'
...
def main():
    ...
    model.module.conv1.iterations = 16
